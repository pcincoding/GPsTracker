...
// import LogoImage from './LogoImage';  && <LogoImage color={theme.palette.primary.main} />
  ...
  return (
    <LoginLayout>
      ...
      <div className={classes.container2}>
        ...
        <h2 className={classes.login}>
          <span style={{ color: 'red' }}>Login </span>
          to Account
        </h2>
        <p>Access our premium tracking platform to monitor your assets all over Nepal.</p>
        ...
        <a href="./forget" style={{ position: 'absolute', top: '415px', left: '195px' }}>Forgot Password?</a>
        {openIdEnabled && (
          <Button
